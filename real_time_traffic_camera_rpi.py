...
# Start the libcamera-vid command to capture video and pipe the output to OpenCV
...
while True:
    ...
    raw_frame = process.stdout.read(1280 * 720 * 3)  # Read raw image data (RGB format)
    if not raw_frame:
        break  # Exit if no more frames

    # Convert the raw frame to a numpy array and reshape it to the correct dimensions
